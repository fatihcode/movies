async function slide(box) {
  ...
  slider.innerHTML = item + `<div style="position: absolute; z-index: 0; bottom: 0px; height: 125px;" class="d-none d-md-block bg-light w-100 bg-opacity-25 justify-content-center"></div>`
}
